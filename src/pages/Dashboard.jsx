  ...
  return (
    <section>
      ...
      <div className="bg-[#000000] p-[28px] lg:mr-[50px] rounded-[15px]">
        ...
        <p className="text-[58px] tracking-[0.075em] font-semibold">1.27%</p>
        ...
        <div className="flex items-center flex-wrap gap-8 mt-4">
          <div>
            ...
            <p className="text-[#FFFFFF] text-4xl font-medium">$12.87</p>
          </div>
          ...
          <div>
            ...
            <p className="text-[#FFFFFF] text-4xl font-medium">2.26 ETH</p>
          </div>
          <div className="bg-[#4E4E4E] w-[1px] h-[71px]"></div>
          <div>
            <p className="text-[#AAAAAA] text-[15px] tracking-[0.075em] mb-1">
        ...
        <div className="grid gap-7">
          <div className="bg-[#000000] pl-[28px] pr-[14px] pt-[18px] pb-[18px] rounded-[15px]">
            ...
            <div className="flex items-end flex-wrap justify-between">
              ...
              <button className="tracking-[0.185em] text-[9px] font-semibold text-black bg-white pl-[38px] pr-[38px] pt-1 rounded-[15px]">
                CLAIM
              </button>
            </div>
          </div>
          ...
          <div className="bg-[#000000] pl-[28px] pr-[14px] pt-[18px] pb-[18px] rounded-[15px]">
            ...
            <div className="flex justify-between items-center mt-7">
              ...
              <div className="flex flex-col items-end gap-[9px]">
                ...
                <button className="text-[14px] pr-[52px] pl-[52px] border-[1px] pt-[1px] rounded-[15px]">
                  LEND
                </button>
              </div>
            </div>
