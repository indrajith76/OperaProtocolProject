...
const Stake = () => {
  ...
  const { unstakeEth,lendEth,txPending,userData,userBalance,connectWallet, addressOfUser,requestRevenue,userOperaBalance,userStakedAmount,stakeOpera, } = useOutletContext();
  const modalHandler = () => {
    setModalOn(!modalOn);
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:pr-[50px]">
        <div className="bg-[#000000] p-[18px] pb-[45px] pl-[28px] rounded-[15px]">
          ...
          <p className="text-[#828282] mt-[6px] text-[13px] mb-[60px]">
            WALLET BALANCE: <span className="text-white">{(userBalance / 10**18).toFixed(3)} ETH</span>
          </p>
        ...
        <div className="bg-[#000000] p-[18px] pb-[45px] pl-[28px] rounded-[15px]">
          ...
          <p className="text-[#AAAAAA] text-[10px] mb-14">ETHEREUM</p>
          ...
          <p className="text-[#828282] mt-[6px] text-[12px] mb-[6px]">
            WALLET BALANCE: <span className="text-white">{parseFloat(userOperaBalance/10**9).toFixed(2)} $OPERA</span>
          </p>
          <p className="text-[#828282] mt-[6px] text-[12px] mb-[60px]">
            STAKED AMOUNT: <span className="text-white">{parseFloat(userStakedAmount/10**9).toFixed(2)} $OPERA</span>
          </p>
